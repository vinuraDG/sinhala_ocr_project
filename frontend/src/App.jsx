    ...
    <div className="home">
      ...
      <section className="cta-section">
        <div className="cta-box">
          ...
          <p className="cta-sub">Start converting handwritten Sinhala text right now.</p>
  ...
  return (
    <div className="page-wrapper">
      <div className="page-header">
        ...
        <p className="page-sub">Upload a photo of handwritten Sinhala text and our AI will convert it to Unicode.</p>
      </div>
...
function CameraPage() {
  ...
  const handleCapture = ({ dataURL, file }) => setCaptured({ dataURL, file });
  ...
  return (
    <div className="page-wrapper">
      <div className="page-header">
        ...
        <p className="page-sub">Point your camera at handwritten Sinhala text and snap a photo.</p>
      </div>
